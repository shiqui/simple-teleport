...
public class TeleportHelper{
    ...
    public static void teleportHome(Player player) {
        ...
        if (home == null) {
            String msg = MessageHelper.stringFromConfig("home.error.no-home");
        ...
        if (CD <= 0) {
            ...
            String msg = MessageHelper.stringFromConfig("home.msg");
            ...
            String msg = MessageHelper.stringFromConfig("home.error.cd");
